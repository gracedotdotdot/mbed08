...

  {
...

    {
...

      {
        ...
        signal2[i] = (float) atof(serialInBuffer);
...

{
...

  {
    ...
    waveform[i] = (int16_t) (signal2[(uint16_t) (i * freq * signalLength * 1. / kAudioSampleFrequency) % signalLength]);
